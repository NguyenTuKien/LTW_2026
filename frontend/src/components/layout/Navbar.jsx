  ...
  return (
    <header className="navbar">
      <div className="navbar-logo">
        ...
        <span className="navbar-logo-text">PTIT Admin</span>
      </div>
      <div className="navbar-search">
        <span className="material-symbols-outlined navbar-search-icon">search</span>
        <input className="navbar-search-input" placeholder="Tìm kiếm kỳ thi, sinh viên, bảo các..." type="text" />
      </div>
      <div className="navbar-actions">
        ...
        <div className="navbar-profile">
          ...
          <div className="navbar-profile-info">
            <p className="navbar-profile-name">Admin, QTV</p>
